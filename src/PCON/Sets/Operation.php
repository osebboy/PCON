...
class Operation
{
	...
	/**
	 * Allows sorting a set with a comparison function.
	 * 
	 * @param SetInterface $set
	 * @param Closure $comp function
	 * @return void | set is sorted depending on the predicate.
	 */
	public static function sort(SetInterface $set, Closure $comp)
	{
		$arr = $set->toArray();
		usort($arr, $comp); 
		$set->build($arr);
